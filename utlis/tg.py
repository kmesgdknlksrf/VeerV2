...
def Ckuser(message):
  ...
  response = requests.get('https://api.telegram.org/bot{}/getchatmember?chat_id=@{}&user_id={}'.format(TOKEN,yousef_labban1,userID)).json()
